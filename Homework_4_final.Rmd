...
DF_rev<-read.csv('/Users/raveena/Desktop/Classroom - R/Marketing Analytics/data/apparel_customer_revenue.csv')
head(DF_rev)
summary(DF_rev)
```
...
On per customer basis<- Segment 3> Segment 1> Segment 2> Segment 4
On total value basis<- Segment 3> Segment 4> Segment 2> Segment 1
Segment 3 has highest probability based on both per customer basis and total value basis.
